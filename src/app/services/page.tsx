...
export default async function ServicesPage() {
  ...
  return (
    <main className="theme-emerald bg-stone-50 text-slate-800">
      ...
      <section className="py-8">
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-between gap-4 rounded-3xl border border-slate-200 bg-white p-6 text-center shadow-sm glass-soft sm:flex-row sm:items-center sm:text-left">
